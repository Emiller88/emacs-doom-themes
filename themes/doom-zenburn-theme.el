...
(def-doom-theme doom-zenburn
  ...
  ((bg         '("#4f4f4e" nil       nil            ))
   ...
   (highlight      blue)
   (vertical-bar   (doom-darken fg 0.1))
   (selection      dark-blue)
   (builtin        fg)
   (comments       (if doom-zenburn-brighter-comments green base5))
   (doc-comments   (doom-lighten (if doom-zenburn-brighter-comments green base5) 0.25))
   (constants      green)
   (functions      cyan)
   (keywords       yellow)
   (methods        cyan)
